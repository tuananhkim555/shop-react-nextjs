...
export default function Nav({ show }) {
  ...
  const activeLink = inactiveLink + " bg-gradient-to-r from-purple-600 via-blue-600 to-purple-600 text-primary rounded-md";
  ...
  return (
    <aside className={(show ? 'left-0' : '-left-full') + " text-gray-700 p-4 fixed w-full bg-bgGray h-full top-0 transition-all duration-300 md:static md:w-auto"}>
